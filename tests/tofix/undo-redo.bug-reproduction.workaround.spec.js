 ...
 * @param {t.TestCase} tc
 */
export const testUndoMapSetAndDeleteFromArrayIn2Steps = tc => {
  ...
  t.assert(arrayHasUnitWithUndefinedContent(array0) === false) // OK
  t.assert(arrayHasUnitWithUndefinedContent(array1) === false) // Here also OK
}
